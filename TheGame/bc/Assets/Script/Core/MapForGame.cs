...
public class MapForGame : MonoBehaviour
{
    ...
    public MapForGame(int num,int t)
    {
        ...
        e[2] = new IndividualEventForGame(0, 0, 300, 0, 0, "路上捡到钱，金钱+300", -1);
        e[3] = new IndividualEventForGame(0, 0, -100, -5, 0, "患上感冒，健康-5，花掉100元", -1);
        e[4] = new IndividualEventForGame(0, 0, -500, 0, 0, "被同学拖去健身，花掉500块，但是健康+10", -1);
        e[5] = new IndividualEventForGame(0, 0, 0, -5, -25, "沉迷网游，无法自拔，健康-5，成绩-25", -1);
        e[6] = new IndividualEventForGame(0, 2, 0, 0, 0, "摔伤了脚，前往校医室停留2回合", 10);
        e[7] = new IndividualEventForGame(0, 1, 0, 0, 0, "逃课被抓，被抓到教学楼停留1回合", 18);
        e[8] = new IndividualEventForGame(0, 0, -50, 5, 0, "吃了一顿营养餐，金钱-50，健康+5", -1);
        ...
        e[11] = new IndividualEventForGame(0, 0, 200, 10, 0, "去练习唱跳rap篮球，健康+10，并因为演出获得200元", -1);
